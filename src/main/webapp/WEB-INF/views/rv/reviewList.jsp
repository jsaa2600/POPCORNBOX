	...
	<div class="content_wrap">
		...
		<div class="row m-0 p-0 list_M" id="replyList">
				<div class="col-4 item"><img src="${pageContext.request.contextPath}/resources/img/noThumbnail.jpg" class="img-thumbnail rounded"></div>
					<div class="col-8">
						...
						<h4 class="label_s mt-3 text-primary"><img src="${pageContext.request.contextPath }/resources/img/face.png" class="rounded-cicle" style="width:50px" alt="" /> 아이디 <small class="mx-2 ">리뷰작성일</small></h4>
		...
		<div class="row m-0 p-0 list_P" id="replyList">
				...
				<div class="col">					
					...
					<h4 class="label_s text-primary"><img src="${pageContext.request.contextPath }/resources/img/face.png" class="rounded-cicle" style="width:50px" alt="" /> 아이디 <small class="mx-2">리뷰작성일</small></h4>
		...
		<div class="row m-0 p-0 list_P" id="replyList">
				...
				<div class="col">					
					<h2 class="label text-light">영 화 제 목<small class="ml-2 label_s">영화장르/2019</small></h2>
					<h4 class="label_s text-primary"><img src="${pageContext.request.contextPath }/resources/img/face.png" class="rounded-cicle" style="width:50px" alt="" /> 날아간 참치 <small class="mx-2">2019.09.26</small></h4>
					<p class="mt-3">댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용
					댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용
					댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용
					댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용
